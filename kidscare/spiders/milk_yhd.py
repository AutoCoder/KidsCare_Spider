            ...
            try:
                for sub_prod in prod.xpath('div'):
                    ...
                    if len(lazyload_attr) and lazyload_attr.extract()[0] != "":
                        ...
                        pic_link = subnode.xpath('a[@class="search_prod_img"]/img/@src | a[@class="search_prod_img"]/img/@original').extract()[0]
                    else:
                        ...
                        pic_link = sub_prod.xpath('a[@class="search_prod_img"]/img/@src | a[@class="search_prod_img"]/img/@original').extract()[0] 
